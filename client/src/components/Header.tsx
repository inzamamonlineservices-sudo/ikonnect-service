...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 w-full border-b border-border transition-colors duration-300 ${scrolled ? 'bg-white dark:bg-background shadow-md' : 'bg-background'}`}>
